...
function createBot() {
   ...
   bot.on('kicked', (reason) => {
      ...
      if (reasonText.includes('You have been idle for too long') || reasonText.includes('Someone with this identity is already in the realm!') || reasonText.includes('You are banned from this server')) {
